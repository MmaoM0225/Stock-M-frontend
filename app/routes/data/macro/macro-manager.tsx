...
import type { MacroManagerOutput } from "~/types/data/macro";
...
const managerOutputByDate = {
  "2026-04-21": {
    ...
    focus_industry_sectors: ["黄金", "贵金属", "贵金属Ⅲ", "贵重金属与矿石", "贵重金属与矿石(A股)"],
    focus_concept_sectors: ["黄金概念", "小金属概念", "稀土永磁"],
    avoid_sectors: ["房地产开发", "房地产服务", "房地产投资信托", "乘用车", "汽车整车", "汽车零部件", "证券", "证券Ⅲ"],
  ...
  "2026-04-20": {
    market_regime: "流动性偏宽松，增长弱修复，市场情绪偏悲观，处于震荡偏弱区间。",
    ...
    risk_factors: ["风险偏好不足导致反弹持续性弱", "制造业景气偏弱，需求端修复不及预期", "商品分化明显，工业链价格中枢下移"],
    confidence: 0.55,
    macro_summary: "市场延续弱势震荡，量能不足制约反弹。流动性环境尚可，但基本面修复不均衡，策略上以防御与结构性机会为主。",
  },
};

export default function DataMacroPage() {
  const availableDates = Object.keys(managerOutputByDate).sort((a, b) => (a > b ? -1 : 1));
  const [selectedDate, setSelectedDate] = useState(availableDates[0]);
  const currentOutput = useMemo<MacroManagerOutput>(
